...
def test_get_search_query_valid_3(user_interaction):
...
def test_get_search_query_valid_5(user_interaction):
    user_interaction._output_menu = MagicMock(return_value="menu")
    user_interaction._get_key_word = MagicMock()
    user_interaction.get_farewell = MagicMock()
...
def test_get_search_query_valid_6(user_interaction):
    user_interaction._output_menu = MagicMock(return_value="menu")
    user_interaction._get_key_word = MagicMock()
    user_interaction.get_farewell = MagicMock()
